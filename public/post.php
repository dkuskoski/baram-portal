					...
					<ul
						class="blog horizontal_carousel autoplay-1 scroll-1 visible-3 navigation-1 easing-easeInOutQuint duration-750">
												...
												for($i = 0; $i < 8; $i ++) {
													...
													echo '<li class="category"><a href="?page=category&amp;cat=health" title="' . $activePosts [$i]->section . '">' . $activePosts [$i]->section . '</a></li> ';
													echo '<li class="date"> ';
					...
					<div class="post single">
						...
						<ul class="post_details clearfix">
							<li class="detail category">In <a
								href="?page=category&amp;cat=health" title="<?php echo $post->section;?>"><?php echo $post->section;?></a></li>
							<li class="detail date"><?php echo date('Y-m-d', strtotime($post->created_at));?></li>
							<li class="detail author">By <a href="?page=author"
								title="Anna Shubina">Baram.be</a></li>
