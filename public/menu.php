	...
	<ul class="sf-menu">
		...
		<!--<li class="submenu mega_menu_parent"><a href="#" title="Mega Menu">
			...
			<ul>
					...
					<ul class="mega_menu blog">
						<li class="post"><a href="?page=post"
							...
							<ul class="post_details simple">
								<li class="category"><a title="HEALTH"
									href="?page=category&amp;cat=health">HEALTH</a></li>
								<li class="date">10:11 PM, Feb 02</li>
							</ul></li>
						<li class="post"><a href="?page=post"
							title="High Altitudes May Aid Weight Control"> <img
								src='images/samples/330x242/image_11.jpg' alt='img'>
						</a>
							<h5>
								<a href="?page=post"
						...
						<li class="post"><a href="?page=post"
							title="Build on Brotherhood, Club Lives Up to Name"> <img
								src='images/samples/330x242/image_06.jpg' alt='img'>
						</a>
							<h5>
								<a href="?page=post"
									title="Build on Brotherhood, Club Lives Up to Name">Build on
				...
				<li class="submenu"><a href="?page=blog" title="Recent Galleries">
						Recent Galleries </a>
					<ul class="mega_menu blog">
						<li class="post"><a href="?page=post_gallery"
							title="Build on Brotherhood, Club Lives Up to Name"> <span
						...
						<li class="post"><a href="?page=post_gallery"
							title="High Altitudes May Aid Weight Control"> <span
								class="icon gallery"></span> <img
								src='images/samples/330x242/image_05.jpg' alt='img'>
						</a>
							<h5>
								<a href="?page=post_gallery"
									title="High Altitudes May Aid Weight Control">High Altitudes
				...
				<li class="submenu"><a href="?page=blog" title="Recent Reviews">
						Recent Reviews </a>
					<ul class="mega_menu blog">
						<li class="post"><a href="?page=post_review"
							title="New Painkiller Rekindles Addiction Concerns"> <span
								class="icon"><span>8.7</span></span> <img
								src='images/samples/330x242/image_07.jpg' alt='img'>
						</a>
							<h5>
								<a href="?page=post_review"
									title="New Painkiller Rekindles Addiction Concerns">New
									Painkiller Rekindles Addiction Concerns</a>
							</h5>
							<ul class="post_details simple">
						...
						<li class="post"><a href="?page=post_review_2"
							title="High Altitudes May Aid Weight Control"> <span class="icon"><span>9.5</span></span>
								<img src='images/samples/330x242/image_09.jpg' alt='img'>
						</a>
							<h5>
								<a href="?page=post_review_2"
									title="High Altitudes May Aid Weight Control">High Altitudes
									May Aid Weight Control</a>
							</h5>
							<ul class="post_details simple">
						...
						<li class="post"><a href="?page=post_review"
							title="Build on Brotherhood, Club Lives Up to Name"> <span
								class="icon"><span>7.8</span></span> <img
						...
						<li class="post first"><a href="?page=post_review"
							title="Nuclear Fusion Closer to Becoming a Reality"> <span
								class="icon"><span>8.0</span></span> <img
								src='images/samples/330x242/image_13.jpg' alt='img'>
						</a>
							<h5>
								<a href="?page=post_review"
						...
						<li class="post first"><a href="?page=post_review_2"
							title="The Public Health Crisis Hiding in Our Food"> <span
								class="icon"><span>9.1</span></span> <img
								src='images/samples/330x242/image_02.jpg' alt='img'>
						</a>
							<h5>
								<a href="?page=post_review_2"
									title="The Public Health Crisis Hiding in Our Food">The Public
									Health Crisis Hiding in Our Food</a>
							</h5>
							<ul class="post_details simple">
								<li class="category"><a title="HEALTH"
									href="?page=category&amp;cat=health">HEALTH</a></li>
						...
						<li class="post first"><a href="?page=post_review_2"
							title="Study Linking Illnes and Salt Leaves Researchers Doubtful">
								<span class="icon"><span>6.7</span></span> <img
				...
				<li class="submenu"><a href="?page=blog" title="Most Read"> Most
						Read </a>
					<div class="mega_menu row">
						...
						<div class="column column_1_2">
							<ul class="blog small">
								...
								<li class="post"><a href="?page=post"
									title="Built on Brotherhood, Club Lives Up to Name"> <img
										src='images/samples/100x100/image_07.jpg' alt='img'>
								</a>
									<div class="post_content">
										<h5>
											<a href="?page=post"
		...
		<!--<li
			...
			<ul>
				<li
					<?php echo ($_GET["page"]=="post" ? " class='selected'" : ""); ?>>
					<a href="?page=post" title="Post Default"> Post Default </a>
				</li>
				<li
					<?php echo ($_GET["page"]=="post_gallery" ? " class='selected'" : ""); ?>>
					<a href="?page=post_gallery" title="Post Gallery"> Post Gallery </a>
				</li>
				<li
					<?php echo ($_GET["page"]=="post_small_image" ? " class='selected'" : ""); ?>>
					<a href="?page=post_small_image" title="Post Small Image"> Post
						Small Image </a>
				</li>
				<li
					<?php echo ($_GET["page"]=="post_video" ? " class='selected'" : ""); ?>>
					<a href="?page=post_video" title="Post Video YouTube"> Post Video
						Youtube </a>
				</li>
				<li
					<?php echo ($_GET["page"]=="post_video_2" ? " class='selected'" : ""); ?>>
					<a href="?page=post_video_2" title="Post Video Vimeo"> Post Video
						Vimeo </a>
				</li>
				<li
					<?php echo ($_GET["page"]=="post_soundcloud" ? " class='selected'" : ""); ?>>
					<a href="?page=post_soundcloud" title="Post Soundcloud"> Post
						Soundcloud </a>
				</li>
				<li
					<?php echo ($_GET["page"]=="post_review" ? " class='selected'" : ""); ?>>
					<a href="?page=post_review" title="Post Review Style 1"> Post
						Review Style 1 </a>
				</li>
				<li
					<?php echo ($_GET["page"]=="post_review_2" ? " class='selected'" : ""); ?>>
					<a href="?page=post_review_2" title="Post Review Style 2"> Post
						Review Style 2 </a>
				</li>
				<li
					<?php echo ($_GET["page"]=="post_quote" ? " class='selected'" : ""); ?>>
					<a href="?page=post_quote" title="Post Quote Style 1"> Post Quote
						Style 1 </a>
				</li>
				<li
					<?php echo ($_GET["page"]=="post_quote_2" ? " class='selected'" : ""); ?>>
					<a href="?page=post_quote_2" title="Post Quote Style 2"> Post Quote
						Style 2 </a>
				</li>
			</ul>
		</li>-->
		<!--<li
			...
			<ul>
				<li
					<?php echo ($_GET["page"]=="blog_small_slider" ? " class='selected'" : ""); ?>>
					<a href="?page=blog_small_slider" title="Blog Small Slider"> Blog
						Small Slider </a>
				</li>
				<li
					class="submenu<?php echo ($_GET["page"]=="blog" || $_GET["page"]=="blog_left_sidebar" ? " selected" : ""); ?>">
					<a href="#" title="Blog 1 column"> Blog 1 Column </a>
					<ul>
						<li
							<?php echo ($_GET["page"]=="blog" ? " class='selected'" : ""); ?>>
							<a href="?page=blog" title="Blog With Right Sidebar"> Blog With
								Right Sidebar </a>
						</li>
						<li
							<?php echo ($_GET["page"]=="blog_left_sidebar" ? " class='selected'" : ""); ?>>
				...
				<li
					class="submenu<?php echo ($_GET["page"]=="blog_2_columns" || $_GET["page"]=="blog_2_columns_left_sidebar" ? " selected" : ""); ?>">
					<a href="#" title="Blog 2 columns"> Blog 2 Columns </a>
					<ul>
						<li
							<?php echo ($_GET["page"]=="blog_2_columns" ? " class='selected'" : ""); ?>>
							<a href="?page=blog_2_columns" title="Right Sidebar"> Right
								Sidebar </a>
						</li>
						<li
							<?php echo ($_GET["page"]=="blog_2_columns_left_sidebar" ? " class='selected'" : ""); ?>>
				...
				<li
					<?php echo ($_GET["page"]=="blog_3_columns" ? " class='selected'" : ""); ?>>
					<a href="?page=blog_3_columns" title="Blog 3 Columns"> Blog 3
						Columns </a>
				</li>
				<li
					<?php echo ($_GET["page"]=="search" ? " class='selected'" : ""); ?>>
					<a href="?page=search&amp;s=Maecenas+Mauris"
...
<div class="mobile_menu_container">
	<a href="#" class="mobile-menu-switch"> <span class="line"></span> <span
